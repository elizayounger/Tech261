...
public class StringBuilder {
    ...
    public static void arrayLists() {
        ...
        CharSequence subSequence(int start, int end) // This method returns a new character sequence that is a subsequence of this sequence.String substring(): This method returns a new String that contains a subsequence of characters currently contained in this character sequence.
